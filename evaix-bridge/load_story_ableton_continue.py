...
CLIP_DIR = Path(r"C:\Users\Gebruiker\ableton-mcp\evaix-bridge\samples\crisp-dna\esx1-molecular-story-168\ableton_clips")
BPM = 168.0
SCENES = [
    (0, "Intro"),
    (1, "Predrop_Vox"),
...
def main():
    ...
    print("ERRORS", errors)
    print("DONE load_story_ableton_continue")
    return 0
