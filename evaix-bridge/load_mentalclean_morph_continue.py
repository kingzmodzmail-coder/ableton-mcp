# -*- coding: utf-8 -*-
"""Continue Ableton STORY clip load — short clips, mix+key stems, timeout-safe."""
from __future__ import annotations
import json, socket, sys
from pathlib import Path

HOST, PORT = "127.0.0.1", 9877
CLIP_DIR = Path(r"C:\Users\Gebruiker\ableton-mcp\evaix-bridge\samples\crisp-dna\mentalclean-molecular-morph-162\ableton_clips")
BPM = 162.0
SCENES = [
    (0, "Intro"),
    (1, "Predrop_Vox"),
...
def main():
    ...
    print("ERRORS", errors)
    print("DONE load_mentalclean_morph_continue")
    return 0
